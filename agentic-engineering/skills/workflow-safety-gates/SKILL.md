...
Prevents: Workflow self-narration, tool-name leakage, MCP/plumbing disclosure, and operator-directed postscripts appearing on externally-visible surfaces (PR bodies, review replies, review submission bodies, pending-review inline comments, Linear comments, commit messages).
