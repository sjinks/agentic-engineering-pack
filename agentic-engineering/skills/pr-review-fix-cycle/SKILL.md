...
Coordinate implementation and verification for validated PR review comments. This skill owns the local fix cycle contract; GitHub context acquisition and allowlisted GitHub mutations remain orchestrator-coordinated through `github-context-agent` for reads and `pr-review-agent` for review replies/thread resolution.
