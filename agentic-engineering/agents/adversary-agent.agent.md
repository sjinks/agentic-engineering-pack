...
5. **Reportable HIGH/MEDIUM finding**: `CONCERNS`.
6. **Only LOW findings, accepted tradeoffs, or no findings**: `CLEAN`; include reportable LOW findings, or `Findings: None` when there are zero.
